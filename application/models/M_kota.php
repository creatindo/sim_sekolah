...
class M_kota extends MY_Model
{
    ...
    function get_limit_data($limit, $start) {
        ...
        $dataorder[$i++] = 'kota_created_date';
        $dataorder[$i++] = 'kota_updated_by';
        $dataorder[$i++] = 'kota_updated_date';
        ...
        if(!empty($this->input->post('kota_created_date'))){
            $where['LOWER(kota_created_date) LIKE'] = '%'.strtolower($this->input->post('kota_created_date')).'%';
        }
        if(!empty($this->input->post('kota_updated_by'))){
            $where['LOWER(kota_updated_by) LIKE'] = '%'.strtolower($this->input->post('kota_updated_by')).'%';
        }
        if(!empty($this->input->post('kota_updated_date'))){
            $where['LOWER(kota_updated_date) LIKE'] = '%'.strtolower($this->input->post('kota_updated_date')).'%';
        }
