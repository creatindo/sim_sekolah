...
class M_kecamatan extends MY_Model
{
    ...
    function get_limit_data($limit, $start) {
        ...
        $dataorder[$i++] = 'kecamatan_created_date';
        $dataorder[$i++] = 'kecamatan_updated_by';
        $dataorder[$i++] = 'kecamatan_updated_date';
        ...
        if(!empty($this->input->post('kecamatan_created_date'))){
            $where['LOWER(kecamatan_created_date) LIKE'] = '%'.strtolower($this->input->post('kecamatan_created_date')).'%';
        }
        if(!empty($this->input->post('kecamatan_updated_by'))){
            $where['LOWER(kecamatan_updated_by) LIKE'] = '%'.strtolower($this->input->post('kecamatan_updated_by')).'%';
        }
        if(!empty($this->input->post('kecamatan_updated_date'))){
            $where['LOWER(kecamatan_updated_date) LIKE'] = '%'.strtolower($this->input->post('kecamatan_updated_date')).'%';
        }
