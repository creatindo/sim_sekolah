      ...
      <div class='portlet light portlet-fit portlet-datatable bordered'>
        <div class='portlet-title'>
            <div class="caption">
                ...
                <span class="caption-subject font-dark sbold uppercase">T_KELAS LIST </span>
            </div>
            <div class="actions">
                <div class="btn-group" >
                        <?php echo anchor('t_kelas/create/','<i class="fa fa-pencil"></i> Create',array('class'=>'btn btn-circle btn-info btn-sm'));?>
                </div>
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu pull-right">
                        <li>
                            <?php echo anchor(site_url('t_kelas/excel'), ' Export to Excel', ''); ?>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <table class="table table-striped table-bordered table-hover" id="mytable">
            <thead>
                ...
                <tr role="row" class="filter">
                    ...
                    <td><input type="text" class="form-control form-filter input-sm" name="t_kelas_active"></td>
        ...
        <script type="text/javascript">
            var TableDatatablesAjax = function () {
                ...
                grid.init({
                    ...
                    dataTable: {  
                        "ajax": {
                            "url": "<?php echo site_url('t_kelas/getDatatable/') ?>", // ajax source
                        },
                        "order": [
                            [1, "asc"]
