              ...
              <div class='portlet light'>
                <div class='portlet-title'>
                  <div class='caption font-green'>
                    <span class='caption-subject bold uppercase'>M_pegawai</span>
                  </div>
                </div><!-- /.title -->
                        ...
                        <div class='form-actions'>
                          <div class='row'>
                            <div class='col-md-offset-5 col-md-7'>
                                <a href="<?php echo site_url('m_pegawai') ?>" class="btn btn-default">Cancel</a>
                                <a href="<?php echo site_url('m_pegawai/update/'.$id) ?>" class="btn btn-info">Edit</a>
                            </div>
                          </div>
                        </div>
                      </td>
