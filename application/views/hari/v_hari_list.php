    ...
    <div class='col-md-12'>
      <div class='portlet light portlet-fit portlet-datatable bordered'>
        <div class='portlet-title'>
            ...
            <div class="actions">
                <div class="btn-group" >
                        <?php echo anchor('hari/create/','<i class="fa fa-pencil"></i> Create',array('class'=>'btn btn-circle btn-info btn-sm'));?>
                </div>
                <div class="btn-group">
        ...
        <script type="text/javascript">
            var TableDatatablesAjax = function () {
                ...
                grid.init({
                    ...
                    dataTable: {  
                        "ajax": {
                            "url": "<?php echo site_url('hari/getDatatable/') ?>", // ajax source
                        },
                        "order": [
                            [1, "asc"]
