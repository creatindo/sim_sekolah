...
class T_ujian_nilai extends CI_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('M_t_ujian_nilai');
    ...
    public function index()
    {
        ...
        $this->template->load('template','t_ujian_nilai_list', $data);
    }
    ...
    public function getDatatable()
    {
        ...
        $t              = $this->M_t_ujian_nilai->get_limit_data($iDisplayStart, $iDisplayLength);
        ...
        if ($get_data) {
            foreach ($get_data as $d) {
                ...
                $delete  = anchor(site_url('t_ujian_nilai/delete/'.$d['nilai_id']),'<i class="fa fa-trash-o fa-lg"></i>',array('title'=>'delete','class'=>'btn btn-outline btn-icon-only red'));
    ...
    {
        $row = $this->M_t_ujian_nilai->get($id);
        if ($row) {
            $data = array(
            ...
            $this->template->load('template','t_ujian_nilai_read', $data);
        } else {
    ...
    public function create() 
    {
        ...
        $this->template->load('template','t_ujian_nilai_form', $data);
    }
    ...
    public function create_action() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->M_t_ujian_nilai->insert($data);
    ...
    public function update_action() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->M_t_ujian_nilai->update($data,$this->input->post('nilai_id', TRUE));
    ...
    public function delete($id) 
    {
        ...
        if ($row) {
            $this->M_t_ujian_nilai->delete($id);
    ...
    public function excel()
    {
		...
		foreach ($this->M_t_ujian_nilai->get_all() as $data) {
            $kolombody = 0;
