...
class T_pegawai extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load('template','t_pegawai_list', $data);
    }
    ...
    public function read($id) 
    {
        ...
        if ($row) {
            ...
            $this->template->load('template','t_pegawai_read', $data);
        } else {
    ...
    public function create() 
    {
        ...
        $this->template->load('template','t_pegawai_form', $data);
    }
    ...
    public function excel()
    {
		...
		xlsWriteLabel($tablehead, $kolomhead++, "Pagawai Id");
		xlsWriteLabel($tablehead, $kolomhead++, "Jabatan Id");
		xlsWriteLabel($tablehead, $kolomhead++, "Create Date");
		xlsWriteLabel($tablehead, $kolomhead++, "T Pegawai Active");

		foreach ($this->M_t_pegawai->get_all() as $data) {
            $kolombody = 0;

            //ubah xlsWriteLabel menjadi xlsWriteNumber untuk kolom numeric
            xlsWriteNumber($tablebody, $kolombody++, $nourut);
		    xlsWriteLabel($tablebody, $kolombody++, $data->pagawai_id);
		    xlsWriteNumber($tablebody, $kolombody++, $data->jabatan_id);
		    xlsWriteLabel($tablebody, $kolombody++, $data->create_date);
		    xlsWriteLabel($tablebody, $kolombody++, $data->t_pegawai_active);
...
/* Generated by Harviacode Codeigniter CRUD Generator 2016-08-07 09:28:58 */
/* http://harviacode.com */