    ...
    public function getDatatable()
    {
        ...
        if ($get_data) {
            foreach ($get_data as $d) {
                ...
                $delete  = anchor(site_url('m_ujian/delete/'.$d['ujian_id']),'<i class="fa fa-trash-o fa-lg"></i>',array('title'=>'delete','class'=>'btn btn-outline btn-icon-only red'));
...
/* Generated by Harviacode Codeigniter CRUD Generator 2016-07-31 04:38:17 */
/* http://harviacode.com */