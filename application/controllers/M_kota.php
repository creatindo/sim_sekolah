...
class M_kota extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load('template','m_kota/v_m_kota_list', $data);
    }
    ...
    public function getDatatable()
    {
        ...
        $t              = $this->M_kota_model->get_limit_data($iDisplayStart, $iDisplayLength);
        ...
        if ($get_data) {
            foreach ($get_data as $d) {
                ...
                $view    = anchor(site_url('m_kota/read/'.$d->kota_id),'<i class="fa fa-eye fa-lg"></i>',array('title'=>'detail','class'=>'btn btn-outline btn-icon-only green'));
                $edit    = anchor(site_url('m_kota/update/'.$d->kota_id),'<i class="fa fa-pencil-square-o fa-lg"></i>',array('title'=>'edit','class'=>'btn btn-outline btn-icon-only blue'));
                $delete  = anchor(site_url('m_kota/delete/'.$d->kota_id),'<i class="fa fa-trash-o fa-lg"></i>',array('title'=>'delete','class'=>'btn btn-outline btn-icon-only red', 'data-toggle'=>'confirm', 'data-title'=>$d->{$this->M_kota_model->label}));
    ...
    public function create() 
    {
        ...
        $this->template->load('template','m_kota/v_m_kota_form', $data);
    }
    ...
    public function create_action() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if ($this->input->post('mode') == 'new') {
                redirect(site_url('m_kota/create'));
    ...
    public function update_action() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->M_kota_model->update($data,$this->input->post('kota_id', TRUE));
    ...
    public function excel()
    {
		...
		foreach ($this->M_kota_model->get_all() as $data) {
            $kolombody = 0;
