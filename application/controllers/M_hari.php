    ...
    public function getDatatable()
    {
        ...
        if ($get_data) {
            foreach ($get_data as $d) {
                ...
                $delete  = anchor(site_url('m_hari/delete/'.$d->hari_id),'<i class="fa fa-trash-o fa-lg"></i>',array('title'=>'delete','class'=>'btn btn-outline btn-icon-only red', 'onclick'=>'return deleteConfirm();'));
