...
class Semester extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load('template','v_m_semester_list', $data);
    }
    ...
    public function read($id) 
    {
        ...
        if ($row) {
            ...
            $data['id'] = $id;
            $this->template->load('template','v_m_semester_read', $data);
        } else {
    ...
    public function create() 
    {
        ...
        $this->template->load('template','v_m_semester_form', $data);
    }
...
/* Generated by Harviacode Codeigniter CRUD Generator 2016-08-08 04:50:49 */
/* http://harviacode.com */