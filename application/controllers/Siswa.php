...
class Siswa extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load('template','siswa/v_siswa_list', $data);
    }
    ...
    public function getDatatable()
    {
        ...
        if ($get_data) {
            foreach ($get_data as $d) {
                ...
                $view    = anchor(site_url('siswa/read/'.$d['t_siswa_id']),'<i class="fa fa-eye fa-lg"></i>',array('title'=>'detail','class'=>'btn btn-outline btn-icon-only green'));
                $edit    = anchor(site_url('siswa/update/'.$d['t_siswa_id']),'<i class="fa fa-pencil-square-o fa-lg"></i>',array('title'=>'edit','class'=>'btn btn-outline btn-icon-only blue'));
                $delete  = anchor(site_url('siswa/delete/'.$d['t_siswa_id']),'<i class="fa fa-trash-o fa-lg"></i>',array('title'=>'delete','class'=>'btn btn-outline btn-icon-only red'));
    ...
    public function read($id) 
    {
        ...
        if ($row) {
            ...
            $data['id'] = $id;
            $this->template->load('template','siswa/v_siswa_read', $data);
        } else {
    ...
    public function create() 
    {
        ...
        $this->template->load('template','siswa/v_siswa_form', $data);
    }
    ...
    public function update_action() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->M_siswa->update($data,$this->input->post('t_siswa_id', TRUE));
...
/* Generated by Harviacode Codeigniter CRUD Generator 2016-08-08 06:46:07 */
/* http://harviacode.com */