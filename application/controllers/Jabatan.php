...
class Jabatan extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load('template','m_jabatan_list', $data);
    }
    ...
    public function read($id) 
    {
        ...
        if ($row) {
            ...
            $this->template->load('template','m_jabatan_read', $data);
        } else {
    ...
    public function create() 
    {
        ...
        $this->template->load('template','m_jabatan_form', $data);
    }
    ...
    public function excel()
    {
		...
		foreach ($this->M_jabatan->get_all() as $data) {
            $kolombody = 0;
...
/* Generated by Harviacode Codeigniter CRUD Generator 2016-07-28 18:57:03 */
/* http://harviacode.com */