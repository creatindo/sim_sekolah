...
class Jabatan extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load('template','v_jabatan_list', $data);
    }
    ...
    public function read($id) 
    {
        ...
        if ($row) {
            ...
            $data['id'] = $id;
            $this->template->load('template','v_jabatan_read', $data);
        } else {
    ...
    public function create() 
    {
        ...
        $this->template->load('template','v_jabatan_form', $data);
    }
...
/* Generated by Harviacode Codeigniter CRUD Generator 2016-08-08 05:05:13 */
/* http://harviacode.com */