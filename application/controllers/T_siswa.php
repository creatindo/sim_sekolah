...
class T_siswa extends CI_Controller
{
    ...
    public function getDatatable()
    {
        ...
        if ($get_data) {
            foreach ($get_data as $d) {
                ...
                $delete  = anchor(site_url('t_siswa/delete/'.$d->t_siswa_id),'<i class="fa fa-trash-o fa-lg"></i>',array('title'=>'delete','class'=>'btn btn-outline btn-icon-only red', 'data-toggle'=>'confirm', 'data-title'=>$d->{$this->T_siswa_model->label}));
    ...
    public function read($id) 
    {
        ...
        if ($row) {
            $data = array(
				...
				't_siswa_active' => @$row->m_status->{$this->M_status_model->label},
			);
            $data['id'] = $id;
    ...
    public function _rules() 
    {
		...
		$this->form_validation->set_rules('t_siswa_active', 't siswa active', 'trim|numeric');
    ...
    public function excel()
    {
		...
		foreach ($this->T_siswa_model->get_all() as $data) {
		    ...
		    xlsWriteNumber($tablebody, $kolombody++, $data->t_siswa_active);
