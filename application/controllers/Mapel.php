...
class Mapel extends CI_Controller
{
    ...
    public function getDatatable()
    {
        ...
        $t              = $this->M_mapel->get_limit_data($iDisplayStart, $iDisplayLength);
        ...
        if ($get_data) {
            foreach ($get_data as $d) {
                ...
                $view    = anchor(site_url('mapel/read/'.$d['mapel_id']),'<i class="fa fa-eye fa-lg"></i>',array('title'=>'detail','class'=>'btn btn-outline btn-icon-only green'));
                $edit    = anchor(site_url('mapel/update/'.$d['mapel_id']),'<i class="fa fa-pencil-square-o fa-lg"></i>',array('title'=>'edit','class'=>'btn btn-outline btn-icon-only blue'));
                $delete  = anchor(site_url('mapel/delete/'.$d['mapel_id']),'<i class="fa fa-trash-o fa-lg"></i>',array('title'=>'delete','class'=>'btn btn-outline btn-icon-only red'));
    ...
    public function update_action() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->M_mapel->update($data,$this->input->post('mapel_id', TRUE));
    ...
    public function excel()
    {
		...
		foreach ($this->M_mapel->get_all() as $data) {
            $kolombody = 0;

            //ubah xlsWriteLabel menjadi xlsWriteNumber untuk kolom numeric
            xlsWriteNumber($tablebody, $kolombody++, $nourut);
		    xlsWriteLabel($tablebody, $kolombody++, $data->mapel_nama);
		    xlsWriteLabel($tablebody, $kolombody++, $data->mapel_active);
...
/* Generated by Harviacode Codeigniter CRUD Generator 2016-07-28 18:56:39 */
/* http://harviacode.com */