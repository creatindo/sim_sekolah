...
class Pegawai extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load('template','m_pegawai_list', $data);
    }
    ...
    public function read($id) 
    {
        ...
        if ($row) {
            ...
            $this->template->load('template','m_pegawai_read', $data);
        } else {
    ...
    public function create() 
    {
        ...
        $this->template->load('template','m_pegawai_form', $data);
    }
...
/* Generated by Harviacode Codeigniter CRUD Generator 2016-08-07 09:29:23 */
/* http://harviacode.com */